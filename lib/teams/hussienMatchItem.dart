...
class HusseinMatchItem extends StatefulWidget {
  final String teamName;
  const HusseinMatchItem({super.key, required this.teamName});

  @override
  State<HusseinMatchItem> createState() => _MatchItemState();
}
